  ...
  return (
    <div style={{ marginTop: '2em' }}>
      <div className="jumbotron text-center">
        <h1>AslTranslator - App to translate ASL into words</h1>
        <h4>
          AslTranslator uses machine learning to transform webcam input into readable
          sign language using a variety of different techniques. The series of
          texts below detail the steps taken for AslTranslator to translate an image
          into a final word.
        </h4>
      </div>
